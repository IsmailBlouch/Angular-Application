...
export class SignupComponent implements OnInit {
  ...
  constructor(private route: Router, private _coreService: CoreService ,
    private fb: FormBuilder,private authService:AuthService, private http: HttpClient) {}
      ...
      if (this.signupForm.valid) {
        ...
        this.authService.signUp(this.signupForm.value)
          .subscribe({
            next: (res) => {
              // alert(res.message)
              this,this._coreService.openSnackBar(res.message,"done")
              // console.log(res);
            ...
            error: (err) => {
              ...
              this._coreService.openSnackBar(err.error.message, "done")
